...
//         return {
//             nodes: [
//                 { name: '话术节点', type: 'DialogNode', desc: '流程返回给用户的话术' },
//                 { name: '条件节点', type: 'ConditionNode', desc: '判断流程走向的节点' },
//                 { name: '采集节点', type: 'CollectNode', desc: '采集用户输入的信息，并在流程中使用' },
//                 { name: '跳转节点', type: 'GotoNode', desc: '流程之间的跳转，或跳转至外部' }
//             ],
//             graph: null,
//             offsetLeft: 0,
//             offsetTop: 0,
...
//         // div.className = 'nodes';
//         // div.innerHTML = 'ssssssssss';
//         // canvas.appendChild(div);
//     },
//     methods: {
//         addHandleNode(x, y, name, type) {
//             this.graph.addNode({
//                 shape: type,
//                 x: x,
//                 y: y,
...
//             this.addHandleNode(e.pageX - this.offsetLeft, e.pageY - this.offsetTop, item.name, item.type)
//         },
//         dragoverDiv(ev) {
//             ev.preventDefault();
//         },
