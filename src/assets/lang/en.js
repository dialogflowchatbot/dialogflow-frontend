export default {
    lang: {
        ...
        flow: {
            ...
            send: 'Send',
            reset: 'Reset',
            changeSaveTip: 'The flow has been modified, do you need to save it?',
        ...
        guide: {
            ...
            title3: 'Need to store user input, or get external data?',
            nav3: 'Create a variable',
            desc3: 'Variables are used to store some uncertain data, which is used in the answer of the dialog flow, conditional judgment.',
